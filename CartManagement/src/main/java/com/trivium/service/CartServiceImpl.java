...
public class CartServiceImpl implements CartService {
    ...
    public CartItem addToCart(String username, Long productId, int quantity) {
        ...
        Optional<CartItem> existingItemOpt = cartItemRepository.findByUsernameAndProductId(username, productId);
	...
	@Override
	public CartItem updateCartItemQuantity(String username, Long productId, int quantity) {
